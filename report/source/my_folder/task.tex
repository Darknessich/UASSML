...
\begin{enumerate}[1.]
	\item Тема работы: {\expandafter \uline{\thesisTitle.}}
	...
	\item Исходные данные по работе: \uline{основными источниками литературы являются статьи \cite{FlightMode} и \cite{UAVOP}.}%
	...
	\begin{enumerate}[label=\theenumi\arabic*.]
		\item Сбор и анализ данных из профильных научных статей.
		\item Исследование и отбор информативных признаков.
		\item Обучение и сравнение стандартных моделей машинного обучения.
		\item Обучение исследовательской модели и сравнение её с базовыми решениями. 
	\end{enumerate}
